"""
wwise_move_object — ak.wwise.core.object.move
...
TOOL_NAME = "wwise_move_object"


def wwise_move_object(
    object_ref: str,
    parent: str,
    ...
    """
    Move a Wwise object to a different parent.

    Args:
        object_ref:       Path or GUID of the object to move.
