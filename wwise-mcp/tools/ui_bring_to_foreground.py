"""
wwise_ui_bring_to_foreground — ak.wwise.ui.bringToForeground
Bring the Wwise authoring application window to the foreground.
"""

from __future__ import annotations
from .client import connect, write_phase2_log, validate_response, get_mock_response

WAAPI_URI = "ak.wwise.ui.bringToForeground"
TOOL_NAME = "wwise_ui_bring_to_foreground"


def wwise_ui_bring_to_foreground(dry_run: bool = False) -> dict:
    """
    Bring the Wwise authoring application window to the foreground.
    ...
    try:
        with connect() as client:
            ...
            if result is None:
                err = "ui.bringToForeground returned None."
...
def register(mcp) -> None:
    mcp.tool()(wwise_ui_bring_to_foreground)
