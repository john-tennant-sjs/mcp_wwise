"""
wwise_undo_begin_group — ak.wwise.core.undo.beginGroup
Begin a new undo group. All subsequent operations are grouped until endGroup or cancelGroup.
"""

from __future__ import annotations
from .client import connect, write_phase2_log, validate_response, get_mock_response

WAAPI_URI = "ak.wwise.core.undo.beginGroup"
TOOL_NAME = "wwise_undo_begin_group"


def wwise_undo_begin_group(dry_run: bool = False) -> dict:
    """
    Begin a new undo group. Must be paired with wwise_undo_end_group or wwise_undo_cancel_group.
    ...
    try:
        with connect() as client:
            ...
            if result is None:
                err = "undo.beginGroup returned None."
...
def register(mcp) -> None:
    mcp.tool()(wwise_undo_begin_group)
